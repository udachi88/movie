	...
	<div class="modal-dialog">
		<div class="panel panel-primary">
			...
			<div class="panel-body" style="text-align:justify;">
				<p><?php echo $config->title;?> respects the intellectual property of others. <?php echo $config->title;?> takes matters of Intellectual Property very seriously and is committed to meeting the needs of content owners while helping them manage publication of their content online.</p>
				<p>It should be noted that <?php echo $config->title;?> is a simple search engine of videos available at a wide variety websites.</p>
